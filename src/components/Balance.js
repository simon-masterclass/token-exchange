...
import tokenIMG from '../assets/dapp.svg';
...
const Balance = () => {
  ...
  }, [exchange, tokens, account, transferInProgress, dispatch, events])
  ...
  return (
    <div className='component exchange__transfers'>
      ...
      {/* Deposit/Withdraw Component 1 (TOKEN) */}

      <div className='exchange__transfers--form'>
        <div className='flex-between'>
          <p><small>Token</small><br /><img src={tokenIMG} alt="Token Logo" />{symbols && symbols[0]}</p>
